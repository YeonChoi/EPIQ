...
namespace InformedProteomics.Test.FunctionalTests
{
    ...
    {
        public const string TestRawFilePath = @"E:\MassSpec\DE\DE_M4_J70_NAQ4_0926_1.raw";
        //public const string TestRawFilePath = @"D:\\DMDE\\raw_data\\2014-10-08(DE_6plex_mix)\\DE_M1_J70_NAQ4_0926_1";
        ...
        public const string TestTopDownRawFilePathEtd = @"E:\MassSpec\DE\DE_M4_J70_NAQ4_0926_1.raw";
        public const string TestTopDownRawFilePathCid = @"E:\MassSpec\DE\DE_M4_J70_NAQ4_0926_1.raw";
        public const string TestQExactiveRawFilePath = @"E:\MassSpec\DE\DE_M4_J70_NAQ4_0926_1.raw";
        public const string TestQExactivePbfFilePath = @"E:\MassSpec\DE\DE_M4_J70_NAQ4_0926_1.pbf";
        ...
        public void TestParsingSpectrumFile()
        {
            ...
            var GetQuantifiedProteins = InMemoryLcMsRun.GetLcMsRun(TestTopDownRawFilePathCid, MassSpecDataType.XCaliburRun);

            const int scanNum = 425;
            var spec = GetQuantifiedProteins.GetSpectrum(scanNum) as ProductSpectrum;
            if (spec != null)
            {
                spec.Display();
                ...
                Console.WriteLine("PrecursorScan: {0}", GetQuantifiedProteins.GetPrecursorScanNum(spec.ScanNum));
                ...
                Console.WriteLine("MsLevel: {0}", GetQuantifiedProteins.GetMsLevel(scanNum));
            }
        ...
        */
        ...
        //    //xic2.Display();
        //    Assert.True(xic1.NumOfBoundLabels == xic2.NumOfBoundLabels);
        //    for (var i = 0; i < xic1.NumOfBoundLabels; i++)
        //    {
        ...
        public void TestGeneratingProductManyXics()
        {
            ...
            for (var i = 0; i < mzArr.Length; i++)
            {
                ...
                //var xic2 = GetQuantifiedProteins.GetFullProductExtractedIonChromatogram2(minMz, maxMz, precursorMzArr[i]);
        ...
        {
            //var GetQuantifiedProteins = new PbfLcMsRun(TestQExactiveRawFilePath);
            var run = PbfLcMsRun.GetLcMsRun(TestQExactiveRawFilePath, MassSpecDataType.XCaliburRun);
            //var GetQuantifiedProteins = InMemoryLcMsRun.GetLcMsRun(TestQExactiveRawFilePath, MassSpecDataType.XCaliburRun);
